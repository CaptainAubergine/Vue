...
!(function (t, e) {
	...
	var Qt = (function (i) {
		...
		return (
				...
				if ((this !== B && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)) {
					...
					this._onUpdate && !e && Pt(this, "onUpdate", !0),
						...
						((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
							this._lock ||
							((!t && g) || !((v === m && 0 < this._ts) || (!v && this._ts < 0)) || ya(this, 1),
			...
			(e.totalTime = function totalTime(t, e) {
				return arguments.length
					? ((this._forcing = 1), !this._dp && this._ts && (this._start = ia(zt.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))), i.prototype.totalTime.call(this, t, e), (this._forcing = 0), this)
					: this._tTime;
			}),
			...
			(e.getTweensOf = function getTweensOf(e, r) {
				for (var i, n = [], a = Ot(e), s = this._first, o = t(r); s;)
					s instanceof $t
						? ka(s._targets, a) && (o ? (!Ut || (s._initted && s._ts)) && s.globalTime(0) <= r && s.globalTime(s.totalDuration()) > r : !r || s.isActive()) && n.push(s)
							...
							for (_.b = r, _.e = i, r += "", (d = ~(i += "").indexOf("random(")) && (i = nb(i)), a && (a((p = [r, i]), t, e), (r = p[0]), (i = p[1])), u = r.match(it) || []; (o = it.exec(i));)
								(l = o[0]),
									...
									((c = parseFloat(u[g - 1]) || 0),
										(_._pt = { _next: _._pt, p: f || 1 === g ? f : ",", s: c, c: "=" === l.charAt(1) ? ja(c, l) - c : parseFloat(l) - c, m: h && h < 4 ? Math.round : 0 }),
										(m = it.lastIndex));
		...
		jt = function _initTween(t, e) {
			...
			if (
				...
				if (((d = (h = A[0] ? ea(A[0]).harness : 0) && _[h.prop]), (r = ta(_, lt)), S && (e < 0 && M && v && !P ? S.render(-1, !0) : S.revert(M && C ? ht : ut), (S._lazy = 0)), g)) {
					if (
						(ya((t._startAt = $t.set(A, pa({ data: "isStart", overwrite: !1, parent: D, immediateRender: !0, lazy: w(y), startAt: null, delay: 0, onUpdate: T, onUpdateParams: b, callbackScope: x, stagger: 0 }, g)))),
					...
					if (
						(e && (v = !1),
							(n = pa({ overwrite: !1, data: "isFromStart", lazy: v && w(y), immediateRender: v, stagger: 0, parent: D }, r)),
							d && (n[h.prop] = d),
	...
	var $t = (function (E) {
		function Tween(e, r, i, n) {
			...
			if (((a._targets = C.length ? da(C) : R("GSAP target " + e + " not found. https://greensock.com", !V.nullTargetWarn) || []), (a._ptLookup = []), (a._overwrite = b), x || T || y(_) || y(m))) {
				if (
					((r = a.vars),
						(s = a.timeline = new Qt({ data: "nested", defaults: M || {}, targets: P && "nested" === P.data ? P.vars.targets : C })).kill(),
				...
				if (p) {
					...
					!(function _renderZeroDurationTween(t, e, r, i) {
						var n,
							...
							l = 0;
						if (
							(h && t._repeat && ((l = xt(0, t._tDur, e)), (a = yt(l, h)), t._yoyo && 1 & a && (u = 1 - u), a !== yt(t._tTime, h) && ((o = 1 - u), t.vars.repeatRefresh && t._initted && t.invalidate())),
							...
							e < 0 && Ba(t, e, 0, !0),
								...
								(e >= t._tDur || e < 0) && t.ratio === u && (u && ya(t, 1), r || I || (Pt(t, u ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()));
	...
	function he(t, e) {
		...
		return s.svg && t.getAttribute("transform")
			...
			: (u !== vr ||
				...
				((n = o.display),
					(o.display = "block"),
					((r = t.parentNode) && t.offsetParent) || ((a = 1), (i = t.nextElementSibling), De.appendChild(t)),
					(u = ge(t)),
	...
	function ue(t, e, r) {
		var i,
			...
			f = r.style;
		for (n in (l.svg
			? ((a = r.getAttribute("transform")), r.setAttribute("transform", ""), (f[hr] = e), (i = Tr(r, 1)), Ud(r, hr), r.setAttribute("transform", a))
			: ((a = getComputedStyle(r)[hr]), (f[hr] = e), (i = Tr(r, 1)), (f[hr] = a)),
			er))
			(a = l[n]) !== (s = i[n]) &&
				"perspective,force3D,transformOrigin,svgOrigin".indexOf(n) < 0 &&
				((o = Xa(a) !== (h = Xa(s)) ? Yd(r, n, a, h) : parseFloat(a)), (u = parseFloat(s)), (t._pt = new me(t._pt, i, n, o, u - o, sd)), (t._pt.u = h || 0), t._props.push(n));
		te(i, l);
	}
	var Se,
		Ae,
						...
						if (((l = typeof o), (f = gr[c]), "function" === l && (l = typeof (o = o.call(i, n, t, a))), "string" === l && ~o.indexOf("random(") && (o = nb(o)), f)) f(this, t, c, o, i) && (T = 1);
							...
							if (
								...
								if (
									(this.styles.save(c),
										g ||
										(((v = t._gsap).renderTransform && !e.parseTransform) || Tr(t, e.parseTransform),
